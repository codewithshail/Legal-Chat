...
return (
  <Sidebar
    variant="inset"
    collapsible="icon"
    className="bg-gray-900 border-r border-gray-700 w-full max-w-[280px]"
  >
    <SidebarHeader className="p-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-white truncate">Legal Assistant</h1>
        <SidebarTrigger />
      </div>
    ...
    <SidebarContent>
      <SidebarGroup>
        <SidebarGroupLabel className="text-gray-400">Recent Chats</SidebarGroupLabel>
        <SidebarGroupContent>
            ...
            <SidebarMenu>
              {isLoading ? (
                ...
                filteredChats.map((chat) => (
                  <SidebarMenuItem key={chat.id} className="flex items-center">
                    <SidebarMenuButton
                      onClick={() => {
                      ...
                      tooltip={chat.title}
                      className="text-white hover:bg-gray-800 truncate w-full"
                    >
